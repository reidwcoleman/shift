...
if __name__ == "__main__":
    names = sys.argv[1:] or [os.path.basename(p) for p in sorted(glob.glob(os.path.join(SRC, "*.png"))) if os.path.basename(p)[:2] in ("20", "21", "22", "23", "24", "25", "26", "27", "29", "30", "31", "32", "33", "34", "35", "36", "06")]
